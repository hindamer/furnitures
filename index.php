            ...
            <div class="container">
               ...
               <?php
                  ...
                  //  $db->_get();
                   ...
                   $data=$pdo->query("SELECT * FROM fur order by image,title desc limit 8"); 
                   $row=$data->fetchAll(PDO::FETCH_ASSOC);
                  ?>
                  <?php
                  foreach($row as $fur){?>
                   <div class="col-lg-3 col-sm-6 col-md-3">
                  <a href="productpage.php?id=<?php echo $fur['id']?>">
                   </form>
                    
                        <div class="box-img">
                           <h4>Product</h4>
                           <img src="./admin/images/<?php echo $fur['image']?>" alt="" width="300" height="300"/>
                        </div>
                     </a>
                  </div>
