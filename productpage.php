            ...
            <div class="container-fluid">
               <div class="row">
                  <div class="col-md-4 col-sm-12 left-rs">
                     ...
                     <form class="navbar-form navbar-left web-sh" action="<?php echo $_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
                        <div class="form">
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <?php
                        ...
                        $id=$_GET['id'];
                        $data=$pdo->query("select * from fur where id ='$id'");
                        $row=$data->fetch(PDO::FETCH_ASSOC);
                        $catid=$row['category_id'];
                        $dat=$pdo->query(" select * from fur where category_id='$catid' and id <> '$id' limit 4");
                        $dat1=$dat->fetchAll(PDO::FETCH_ASSOC);
                     ?>
            ...
            <div class="row">
                  ...
                  <div class="md-prod-page">
                        ...
                        <div class="page-preview">
                           <div class="preview">
                              <div class="preview-pic tab-content">
                                 <div class="tab-pane active" id="pic-1"><img src="./admin/images/<?php echo $row['image']?>" alt="#" /></div>
                     ...
                     <div class="description-box">
                        <div class="dex-a">
                           ...
                           <br>
                           <p>Small: <?php echo $row['small']?></p>
                           <p>Large: <?php echo $row['large']?></p>
                        </div>
                        <div class="spe-a">
                       ...
                       foreach($dat1 as $d3){?>
                        ...
                        <div class="small-box-c">
                           <div class="small-img-b">
                              <img class="img-responsive" src="./admin/images/<?php echo $d3['image']?>" alt="#" />
                           </div>
                           <div class="dit-t clearfix">
                              ...
                              <a href="#" tabindex="0">$<?php echo $d3['price']?></a>
                           </div>
                           <div class="prod-btn">
                              <a href="#"><i class="fa fa-star" aria-hidden="true"></i> Save to wishlist</a>
                              <a href="#"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Like this</a>
               ...
               <div class="col-md-3 col-sm-12">
                  <div class="price-box-right">
                     <h4>Price</h4>
                     <h3>$<?php echo $row['price']?> <span>pr.peice</span></h3>
                     <p>Option</p>
